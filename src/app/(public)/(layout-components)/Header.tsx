...
const Header = () => {
  ...
  return <>
    <InView as="div" className="absolute top-0 left-0" threshold={.25} initialInView={true} fallbackInView={true}
    ...
    <header ref={header}>
      <div className="py-10 px-5 lg:px-24 gap-7 inner flex items-center justify-center">
        ...
        <button className="ml-auto btn btn-primary flex flex-row items-center">
          <FaDownload />
          <span>Download</span>  
        </button>
      </div>
